...
export default function SobreMim() {
	return (
		<PostModelo fotoCapa={fotoCapa} titulo="Sobre Mim">
			<h3 className={`text-amber-500 ${styles.subtitulo}`}>Olá, eu sou o Kevin</h3>

			<img src={fotoSobreMim} alt="Foto" className={styles.fotoSobreMim} />

			<p className={`text-amber-50 ${styles.paragrafo}`}>
			...
			<p className={`text-amber-50 ${styles.paragrafo}`}>
				...
				Eu aprendi lógica de programação e o básico de várias linguagens,
				como PHP, Python, Java, mas sem aprofundar muito em cada uma delas.
				Eu gostava muito de estudar programação, mas na época não fazia
				ideia de que trabalharia com isso hoje.
			</p>
			<p className={`text-amber-50 ${styles.paragrafo}`}>
				No ensino superior, escolhi cursar Engenharia Elétrica na
				Universidade Federal do Piauí (UFPI). Lá eu consegui entrar no PET
				(Programa de Educação Tutorial), um grupo acadêmico que contribui de
				diversas formas para o curso. Lá eu tive a oportunidade de estudar
			...
			<p className={`text-amber-50 ${styles.paragrafo}`}>
				...
				desenvolvimento web. Eu encontrei uma vaga na Alura para o Scuba
				Team e percebi que ela aliava duas paixões minhas: programação e
				educação. Para minha felicidade, fui escolhido para fazer parte do
				time.
			</p>
			<p className={`text-amber-50 ${styles.paragrafo}`}>
				...
				oportunidade de trazer esses conteúdos ricos e encantadores para
